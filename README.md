...
- Windows desktop app for playing audio on WiiM devices from direct stream URLs, such as internet radio stations or podcasts.
- Import a list of direct stream URLs into the app.
- Basic player controls and equaliser preset selection.

I created this app because this functionality does not currently exist in the official WiiM desktop app. In the WiiM mobile app it does exist, it's called 'Open Network Stream'. However, when sitting at your computer it’s more convenient to control your WiiM device directly from the desktop rather than reaching for your smartphone.
